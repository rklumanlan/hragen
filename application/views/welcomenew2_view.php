    ...
    <div class="container">
        <div class="row">
            <div id="regf" class="col-lg-12 reg_form border col-xs-10 col-sm-10 col-md-10 col-lg-8 col-xs-offset-1 col-sm-offset-1 col-md-offset-1 top">
                    ...
                    <div class=" update_pinfo2 form-horizontal focus" tabindex='1'>
                        ...
                        <div class="form-group" >
                            <div class="pull-right pads edtpinfo ">
                               ...
                               class="btn btn-primary edtpinfobtn invi"value="Cancel" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class=" col-lg-12 form-horizontal">
                    <div class='col-lg-12 form_title space bg'>Technical Skills</div >
                        ...
                        <div class="pull-right pads edttskills space ">
                            ...
                            &nbsp;<input type="button" id="canceltskills_mpage" name="edttskills" class="btn btn-primary edttskillsbtn invi"
                            value="Cancel" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 educ1 space">
                        <div class="col-lg-12 focus" id="educ<?php echo $educ->educ_id; ?>" tabindex='3'>
                            <div class="col-sm-12 bold">
                                ...
                                id='educ".$educ->educ_id."'></span> ".$educ->school; ?>
                            </div>
                            <div class="col-sm-12">
                               <?php echo "<span class='glyphicon glyphicon-edit edit click'
                                id='educ".$educ->educ_id."'></span> ".$educ->yearFrom." - ".$educ->yearTo; ?>
                            </div>
                            <div class="col-sm-12">
                                <?php echo "<span class='glyphicon glyphicon-edit edit click'
                                id='educ".$educ->educ_id."'></span> ".$educ->degree.", ".$educ->fstudy; ?>
                            </div>
                            <div class="col-sm-12">
                               <?php if($educ->desc!=""){echo "<span class='glyphicon glyphicon-edit edit click'
                              id='educ".$educ->educ_id."'></span> ".$educ->desc;} ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php foreach($comp as $comp){ ?>
                        ...
                        <div class="space col-lg-12 focus" id='comp<?php echo $comp->comp_id; ?>' tabindex='4'>
                            ...
                            <div class="col-sm-12">
                                <?php
                                if($comp->month2==13){
                                echo "<span class='glyphicon glyphicon-edit edit click' id='comp".$comp->comp_id."'>
                                </span> "; month($comp->month1); echo " ".$comp->year1." - "; echo "Present";
                                }
                                else{
                                echo "<span class='glyphicon glyphicon-edit edit click' id='comp".$comp->comp_id."'>
                    ...
                    <?php echo"
                        <div id='2comp".$comp->comp_id."' class='comp focus invi' tabindex='4'>
                            ...
                            <div class='form-group invi updbuttons'  >
                                ...
                                class="btn btn-primary edtcompbtn2 " ');
                                echo'&nbsp;<input type="button" id="comp'.$comp->comp_id.'"
                                class="cancelupdate btn btn-primary edtcompbtn2" value="Cancel" />
                                </div>
                ...
                <div class=" col-lg-12">
                    ...
                    <div class="col-lg-12 form-horizontal  ">
                        ...
                        <div class="form-group" >
                            <div class="pull-right pads edtpref ">
                                 <?php echo form_submit('insertpref','Save', 'id="insertpref" class="btn btn-primary edtprefbtn invi" ');?>
