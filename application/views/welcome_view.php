    ...
    <div class="container">
        <div class="row">
            <div id="regf" class="col-lg-12 reg_form col-xs-10 col-sm-10 col-md-10 col-lg-8 col-xs-offset-1 col-sm-offset-1 col-md-offset-1 top ">
              <?php  echo form_open_multipart("user/preview",'id = "infos"'); ?>
                <h3 class="section-heading">Registration Form</h3>
                <div class="panel panel-info" >
                  ...
                  <div style="padding-top:30px" class="panel-body form-horizontal" >
                    ...
                    <div class="form-group pic">
              				...
              				<div class="col-sm-9">
                        <input type="file" id="userfile" name="userfile" class="form-control" size="20" required="required" />
                      </div>
                      ...
                      if(count($language)>0){
                        foreach($language as $language){
                          echo "<div class='col-sm-3 '>
                                  <label class='checkbox-inline '><input type='checkbox' name='lang[]'class='edttskills' value='".$language->lang_desc."'>"
                                  .$language->lang_desc."</label>
                                </div>";
                        }
                      }
                      ?>
                ...
                <div class="panel panel-info" >
                  ...
                  <div style="padding-top:30px" class="panel-body form-horizontal" >
                    ...
                    <div class="form-group" >
                        ...
                        <input type="button" id="addedu" class="btn btn-primary" value="Add Another" />
                        <input type="button" id="remedu" class="btn btn-primary" value="Remove" />
                ...
                <div class="panel panel-info" >
                  ...
                  <div style="padding-top:30px" class="panel-body form-horizontal" >
                    ...
                    <div class="form-group" >
                    	<div class="col-xs-offset-6 col-sm-offset-8 col-md-offset-8 col-lg-offset-9 ">
                        	<input type="button" id="addpexp" class="btn btn-primary" value="Add Another" />
                            <input type="button" id="rempexp" class="btn btn-primary" value="Remove" />
                        </div>
                    </div>
                  </div>
                </div>
                <div class="panel panel-info" >
                  ...
                  <div style="padding-top:30px" class="panel-body form-horizontal" >
                    ...
                    <div class="form-group" >
                    	<div class="col-xs-offset-6 col-sm-offset-8 col-md-offset-8 col-lg-offset-9 ">
                        <input type="button" id="addref" class="btn btn-primary" value="Add Another" />
                        <input type="button" id="remref" class="btn btn-primary" value="Remove" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group" >
                <div class="col-xs-offset-6 col-sm-offset-8 col-md-offset-8 col-lg-offset-10 ">
