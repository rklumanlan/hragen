            ...
            <!-- Brand and toggle get grouped for better mobile display -->
             <div class="navbar-header">
                ...
                <?php echo anchor('user/welcomenew', 'Human Resource Agency','class="navbar-brand"'); ?>
            </div>
		...
		<div class="form-horizontal focus" tabindex='1'>    
            ...
            <div class="tskills focus" id="tskills" tabindex='2'>
                ...
                <div class="form-group">           
                    ...
                    if(count($os)>0){
                        foreach($os as $os){ 
                                if (preg_match("~\b".$os->os_desc."\b~",$sel_os_list)) {
                                    $select="checked";
                                }
                                else{
                                    $select="";
               ...
               <?php 
				if(count($fwork)>0){
					foreach($fwork as $fwork){ 
							if (preg_match("~\b".$fwork->fwork_desc."\b~",$sel_fwork_list)) {
								$select="checked";
							}
							else{
								$select="";
