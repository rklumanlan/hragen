    ...
    <div class="container">
		...
		echo "</div>";
			...
			foreach($comp as $comp)
			{
				...
				<div id='comp".$comp->comp_id."' class='com focus' tabindex='4'>
					...
					<div class='form-group comTP".$comp->comp_id."'>
						...
						<div class='col-sm-9 '>
							...
							<div class='col-sm-2 pad'> - </div>";
              if ($comp->month2 == 13){$check="checked='checked'";}
              else {$check="";}

              echo "
							<div class='col-sm-3 pad to' id='".$comp->comp_id."'>";
							...
							echo"</div>
							<div class='col-sm-2 pad to' id='to".$comp->comp_id."'>
              ...
              <div class='col-sm-5 pad to invi' id='idTo".$comp->comp_id."'>
                <input type='text' value='Present' class='form-control present' id='present".$comp->comp_id."' readonly='true'/>
              </div>
              <div class='col-sm-5 pad col-sm-offset-6'>
                <input type='checkbox' id='cbox_work".$comp->comp_id."' ".$check." disabled class='cbox'> I currently work here
              </div>";
...
alert('dddd');
    ...
    else if($("#"+$(".cbox").attr('id')).prop('checked',false)){alert('dasf');
      var cbox = $(".cbox").attr('id');
      var cbox = cbox.replace(/\D/g, "");
      $("#"+ cbox).show();
      $("#to"+ cbox).show();
